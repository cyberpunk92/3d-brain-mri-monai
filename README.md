...
Standardize 3D compressed NIfTI neuroimaging volumes.

Apply affine reorientation and isotropic voxel resampling.

Perform 3D convolutional segmentation inference using a volumetric UNet architecture.

Extract synchronized orthogonal cross-sections (Axial, Coronal, Sagittal) with segmented lesion overlays.
